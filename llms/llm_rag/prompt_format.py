...
class PromptLoader:
    ...
    def add_messages_placeholder(self, variable_name: str):
        ...
        self.input_types[variable_name] = List[Union[AIMessage, HumanMessage, ChatMessage, SystemMessage, FunctionMessage]]
        return self
...
def create_ns_rag_prompt(system_template: str, system_prompt_args: list, human_template: str, human_prompt_args: list):
    return (PromptLoader()
            ...
            .set_input_type('messages', List[Union[AIMessage, HumanMessage, ChatMessage, SystemMessage, FunctionMessage]])
            .create_prompt())
